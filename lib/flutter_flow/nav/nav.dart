...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'buyer_user_order',
          path: '/buyerUserOrder',
          builder: (context, params) => BuyerUserOrderWidget(
        ...
        FFRoute(
          name: 'buyer_user_release',
          path: '/buyerUserRelease',
          builder: (context, params) => BuyerUserReleaseWidget(
            buyerUserId: params.getParam(
              'buyerUserId',
              ParamType.int,
            ),
